  ...
  return (
    <div className='containter_page'>
      ...
      <div className='container_table--reservas-cliente'>
        ...
        <Table columns={columns} datos={reservas} textBtn1={"Reagendar"} textBtn2={"Cancelar"} actionBtn1={redirectSeleccionarFechaHora} actionBtn2={solicitarCancelacionReserva} table_width={"table_big"} class_margin={"table_margin_none"} />
