        ...
        <div className='container_form_alta_reserva'>
            ...
            <form ref={formRef} onSubmit={onSubmit}>
                ...
                <div className='container_gruop_datos'>
                    ...
                    <InputForm tipo={"text"} id={"nombreComprador"} labelDescription={"Tu nombre :"} name={"nombreComprador"} placeholder={"Ingresa tu nombre"} esRequerido={true} isDisabled={cliente?.nombre ? true : false} value={cliente ? cliente.nombre : ""} />

                    <InputForm tipo={"text"} id={"emailComprador"} labelDescription={"Tu email:"} name={"emailComprador"} placeholder={"Ingresa tu email"} esRequerido={true} isDisabled={cliente?.email ? true : false} value={cliente ? cliente.email : ""} />
                </div>

                <div className='container_gruop_datos'>
                    <InputForm tipo={"text"} id={"celularComprador"} labelDescription={"Tu celular:"} name={"celularComprador"} placeholder={"Ingresa tu celular"} esRequerido={true} isDisabled={cliente?.celular ? true : false} value={cliente ? cliente.celular : ""} />
