...
namespace Domain.Models
{
    public class Servicio
    {
        ...
        public Servicio(string nombre, string descripcion, double precio,int descuento, DisponibilidadServicio disponibilidad, CategoriaServicio categoria, int tiempoDeDuracionMin)
        {
            Nombre = nombre;
